                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(right: 20),
                          child: Text('Chest',style: TextStyle(color: Colors.white70,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ),
                  width: getwidth(context)*0.3,
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(right: 20),
                          child: Text('Tricpes',style: TextStyle(color: Colors.white70,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ),
                  width: getwidth(context)*0.3,
