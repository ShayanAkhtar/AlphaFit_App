                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Text('Back',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(right: 20),
                          child: Text('Biceps',style: TextStyle(color: Colors.white70,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ),
                  width: getwidth(context)*0.3,
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(right: 20),
                          child: Text('Forearms',style: TextStyle(color: Colors.white70,fontSize: 15,fontWeight: FontWeight.bold),))
                    ],
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  ),
                  width: getwidth(context)*0.3,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                      margin: EdgeInsets.only(right: 20),
                      child: Text('Shoulders',style: TextStyle(color: Colors.white70,fontSize: 15,fontWeight: FontWeight.bold),))
                ],
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              ),
              width: getwidth(context)*0.3,
